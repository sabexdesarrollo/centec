...
export default function Inscription() {
  return (
    <div
    id="inscripcion"
    className="overflow-hidden py-20 sm:py-32 lg:py-32"
  >
      ...
      <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
        <div className="relative mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
          ...
          <p className="mt-6 text-base lg:text-lg text-gray-200 pb-8">
            ...
            como emprendedor independiente o dependiente, a través de
        ...
        <div className="relative mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
          ...
          <p className="mt-6 lg:text-lg text-base text-gray-200">
            ...
            altamente calificados, críticos y generadores de cambios positivos
            para el sector: Productivo, Comercio y Servicios, a través de la
            formación y capacitación ahondando en la investigación.
          </p>
        </div>
