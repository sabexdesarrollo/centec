export default function InstitutionalHorizon() {
  return (
    <section
      id="horizonte-institucional"
      className="relative -z-50 overflow-hidden py-20 sm:py-32 lg:py-32 bg-white"
    >
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            ...
            <p className="mt-6 text-base lg:text-lg text-secondaryDarkBlue/80 pb-8">
              ...
              educativas, fomentando la inclusión y la igualdad de oportunidades
              para adultos de todas las edades y antecedentes. Buscamos
              empoderar a nuestros estudiantes para que desarrollen habilidades
              académicas y personales, promoviendo el aprendizaje a lo largo de
          ...
          <div className="relative mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            ...
            <p className="mt-6 lg:text-lg text-base text-secondaryDarkBlue/80">
              ...
              Visualizamos un entorno educativo inclusivo y diverso que fomente
              el desarrollo de habilidades críticas y ciudadanas en nuestros
              estudiantes, preparándolos para enfrentar los desafíos del siglo
              XXI. Aspiramos a ser un puente hacia nuevas oportunidades, donde
              la educación sea una fuerza transformadora en la vida de nuestros
