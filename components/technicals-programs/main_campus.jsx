      ...
      <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-10">
        {campus.map((item, index) => (
          <button
            ...
            className={`relative text-left z-0 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none w-full lg:pt-6 xl:col-span-6 border-2 ${borderColor} shadow-gray-600 bg-gradient-to-r ${bgLeft} ${bgRight} shadow-md p-4 rounded-lg my-4 lg:my-0 hover:opacity-50 hover:transition-opacity cursor-pointer hover:delay-0`}
          >
